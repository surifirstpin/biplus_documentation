...
## Adding Global Filters
 ...
 the report data is retrieved based on filter applied in analysis section, but if the data retrieved should be based on different
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4NDQ5OTk4NTldfQ==
-->