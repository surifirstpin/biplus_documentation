...
## Lookup Single & Multiple
 ...
 By adding lookup to reports you can refer set of query or list of items in filters.you can add dingle or multiple looks to a dashboard report by clicking on ** Add Lookups
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkxMzA1MDQwOF19
-->