...
## Adding Global Filters
 ...
 The report data is retrieved based on filter applied in analysis section, but if the data retrieved should be based on different filter value then it should be derived under global filters in dashboard section.
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ1MzcxOTI2MV19
-->