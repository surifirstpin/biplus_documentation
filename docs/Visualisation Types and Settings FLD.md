...
-  **Align**   it defines the position of the label relative to the anchor point position and direction. Its value can be expressed by one of the following string presets:
   ...
   - **Anchor** The label position is calculated based on the anchor option 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MjU2NjY4OTUsLTg4ODg2MTk1NCwyNT
U5OTcwODMsLTE5NzUzNDExNjMsMTYyOTQ2ODk2LC0yMDY0Mjg2
MzA2LDEyNjA2MDQxNjYsNTYzODQ0MzY2LDExODI0MDYwOTYsLT
cxOTE4NTE2NSwxNTkzODQ4NjgzLC0xOTE0NDk2MTQ1LC0xMzEx
NDE0MjUwLDE3Njg5NDA2NDksLTkyOTcwNTY3LC0zOTcxNjc4OT
csMTI2ODQxMTY0LDExODY2MjE1NywtMjA2NTE3NzM1MCwxMDQ2
MTU4NjY4XX0=
-->