...
- **Stacked** Set of Values are added on the Y-axis by displaying  each consecutive values above the last. ( al
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTU3MTYxNDA3LDEyNjA2MDQxNjYsNTYzOD
