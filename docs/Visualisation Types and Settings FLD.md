...
**10.** To view the **World chart** click on **world** tab under **General** section.
 ...
 > **Note :** The data you want to define in world chart, should be defined in model section first.  data field values will be displayed here.  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMTc0MDc2NjksLTE5OTY2NDYzMTAsNz
