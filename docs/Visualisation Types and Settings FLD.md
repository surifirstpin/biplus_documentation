...
- **Custom Label** Using this option you can display your own customized label for the column field value. Add a prefix or Suffix at starting or ending position of the label value.
