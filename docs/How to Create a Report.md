...
After learning on how to browse a reports, User navigate to next section on how to Create there report
...
## Group / Un-Group
You can view the consolidated value of the field by setting **Group** option for fields. To carry out this function click on **Group** in field drop down provided and to release the same click on **Un-Group**( Refer image 4).**
 ...
 **Format** Tab is also enabled based on data retrieved,  it allows different type of number format to measure field value. Following are the list of number formats supported by BiPlus ;
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMwODk2ODkxMCwtMjA1MDUwMzQ1Nyw5MT
g2MTQyMDcsLTk0NTg1ODU5MCwtMTMyNTAzNTA3NiwxNjgzNzMz
NjM4LC0xNjQ5MDQyNTcyLC0xODY0OTYxODQwLC0xMzA3MDcwMD
IsMTQ1NTk1MTY5Miw3NzI1MTA2NjcsLTMxNDU0Mzc0MywxNjcx
NTc2MzQ5LC05MDUzMjc3MjQsMjY1MTUwMjQsNDk4Nzk2MjQ4LD
EyMDA1ODk1NTksLTIwMTgwODE4OTMsMTQyODEzMTU0OCwtMTA3
NzM3ODM4XX0=
-->