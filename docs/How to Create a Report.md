...
- **Legend** To display a lebel, the wait will enable you to change the label for measure value in visualization charts as shown below.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNTE4OTU0MjksLTE1NzM1NjQ1MDcsMT
