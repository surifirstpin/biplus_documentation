...
**2.** Select Desired **Project** and **Model** at top left from the drop down list, depending on which you want to extract the data.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjUyODcyMjY5LDE2ODM3MzM2MzgsLTE2ND
