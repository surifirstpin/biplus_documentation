...
When drilling on a dimension, the new query filters on the drilled value. For example, if you click on a specific month in a query of customer order by month, the new query will show only orders o.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDY3NDQ1NzQ3XX0=
-->