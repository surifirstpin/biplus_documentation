...
When drilling on a dimension, the new query filters on the drilled value. For example, if you click on a specific in a query of customer orders by date, the new query will show only orders on the specific date.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTEzMzE4OTkwN119
-->