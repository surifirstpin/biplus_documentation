...
- When **drilling on a dimension,** the new query filters on the drilled value. For example, if you click on country name it willl show the state and branchcode
```
{
			"name": "BRANCHCODE",
			"label": "BRANCHCODE",
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3ODAxNzczMzddfQ==
-->