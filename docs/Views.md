...
When drilling on a dimension, the new query filters on the drilled value. For example, if you click on a specific month in a query of customer order by month, the new query will show only orders in sp.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODM0MTM2NzAwXX0=
-->