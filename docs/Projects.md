...
To remove tables from database select the check boxes of selected tables from right side section and you click on delec 
## Auto Build Joins
...
## Privacy & Share Option to Projects
          ...
          welcome to Biplus
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIwNzAxOTQ2OF19
-->