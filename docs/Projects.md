...
To remove tables from database select the check boxes of selected tables from right side section and you click on deselect option available to remo 
## Auto Build Joins
...
## Privacy & Share Option to Projects
          ...
          welcome to Biplus
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk2OTA4MzI5MF19
-->