...
To remove tables from database select the check boxes under **Selected  section or else you can click on **deselect all** option available to remove all tables at a time.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MTQzNDE3MDJdfQ==
-->