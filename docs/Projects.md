...
To remove tables from database select the check boxes under  section or else you can click on **deselect all** option available to remove all tables at a time.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIzNzkzNzk4OV19
-->