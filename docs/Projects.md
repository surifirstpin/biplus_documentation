...
To remove tables from database select the check boxes of selected tables from right side section and you click on deselect optioo 
## Auto Build Joins
...
## Privacy & Share Option to Projects
          ...
          welcome to Biplus
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY5NzU4OTA4XX0=
-->