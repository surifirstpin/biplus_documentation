...
Analysis is the starting point of the query, it is designed in such a way that it explores the particular subject area and where to pull the data and how to modify the report and drill down deeper into the report for more insight.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAzNzMxOTM5NiwtMTkxMjg4NDQ3OCw0Mj
