...
- **Datasets** enables you to perform alignment, set currency formats for measure values and perform group aggregates ( ) on the consolidated values of the field/
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTcwNjEzNDQ5MywtMTkxMjg4NDQ3OCw0Mj
