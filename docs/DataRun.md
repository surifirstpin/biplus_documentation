...
Analysis is the starting point of the query, it is designed in such a way that it explores the particular subject area and where to pull your data and how to modify the report and drill down deeper into the report for more insight.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc4MDI4NjA5NCwtMTkxMjg4NDQ3OCw0Mj
