...
Analysis is the starting point of the query, it is designed in such a way that it retrieves the data in the desired combinations as per your business needs and explores the particular subject area it self and provides an ability  pull the data and how to modify the report and drill down deeper into the report for more insight.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk5MzE4MTI0NCwtMTkxMjg4NDQ3OCw0Mj
