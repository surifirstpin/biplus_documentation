...
On applying hidden filters to the dimensions, the column fields are visible in the list of filter expression specified and displays the data depending on the filters applied.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MzIxMTkwNjYsLTE5MTI4ODQ0NzgsND
