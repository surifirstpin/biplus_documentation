...
To view the column data in ascending and descending orders add the fields in order section and select the desired view for the col.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzMDY1MzY4OTIsLTE5MTI4ODQ0NzgsND
