...
To **Pivot** a dimension click on pivot for dimension before running the query and you can add more pivots to other dimension but make sure you have atleast one un
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwOTQ3MTM5ODIsLTE5MTI4ODQ0NzgsND
