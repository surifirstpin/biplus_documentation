...
A measure is a list of fields that uses a SQL aggregate function, such as COUNT, SUM, AVG, MIN or MAX. Any field computed based on the values of other measure values is also a measure. Measures can be used to filter grouped values. For example, measures for a “Sales”
...
## Pivot table
                  ...
                  welcome to biplus
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI5NDExMzYzNF19
-->