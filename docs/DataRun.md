...
To view the column data in ascending or descending orders , add the column fields in order section to carry out the ordering and select the desired view for the column field.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODgxOTYyOTgwLC0xOTEyODg0NDc4LDQyOT
