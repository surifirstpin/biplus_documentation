...
- **Calculate on the raw data** this function is applied directly on the retreived value of tyhe fieldwinitially before pivot or grouping or else applied later.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk4OTY4MTAwMF19
-->