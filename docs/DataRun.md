...
To view the column data in ascending or descending orders , add the column fields in order section to carry out the sorting on the field values. field.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAyNjc2NTEyMywtMTkxMjg4NDQ3OCw0Mj
