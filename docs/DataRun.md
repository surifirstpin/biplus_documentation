...
Analysis section retrieves the data in the desired combinations by allowing 
 slice and dice of the data information, AcuBi provides you an ability to explore the data by applying following functions Filters, Order,  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTkzMDY1MTE4LC0xOTEyODg0NDc4LDQyOT
