...
Analysis is the starting point of the query, it is designed in such a way that it explaisn  where to pull your data and how to modify the report and how to drill down deeper into the report for more insight.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExNjg0MzEyOTksLTE5MTI4ODQ0NzgsND
