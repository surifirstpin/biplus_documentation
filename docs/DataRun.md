...
- **Calculate on Raw data** Calculates the fields value before applying grouping ,pivot or other parameters or else calculates 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk5MzE3ODg4MF19
-->