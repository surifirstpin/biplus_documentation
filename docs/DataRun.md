...
Using **Analysis section** you can retrieve the data in the desired combinations as per your business needs  by allowing slice and dice of the data, AcuBi provides you an ability to explore the data by applying following functions Filters, Order, Sorting, Mathematical Calculations etc.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDUwNTQwODE4LC0xOTEyODg0NDc4LDQyOT
