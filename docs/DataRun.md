...
By selecting group option for fields you can group the data and display the consolidated value of the field. To carry out this function Click on **Group** for the field and to release the same Click on **Un-Group**. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU5Mzc1MjA2NCwtMTkxMjg4NDQ3OCw0Mj
