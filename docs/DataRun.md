...
To Freeze the column field values while scrolling the data to right or left click **Pin** for the field. option by clicking on down arrow of the field header  to release the same click on **Remove Pin.**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY3OTg0NDg5NCwtMTkxMjg4NDQ3OCw0Mj
