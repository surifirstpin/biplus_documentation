...
Analysis is the starting point of the query, it is designed in such a way that it explains where to pull your data and how to modify the report and drill down deeper into the report for more insight.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzY2NTI3MzAsLTE5MTI4ODQ0NzgsNDI5Nj
