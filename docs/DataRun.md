...
## Group / Un-Group
 ...
 In Order to retreive the total value Select **Group** options to group fields and select **Un-Group** to release the same.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTEzNzQ1MTY5LC0xOTEyODg0NDc4LDQyOT
