...
To **Pivot** a dimension click on pivot for dimension before running the query, you can add more pivots to other dimension but make sure you have at least one pivoted dimension and a measure.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyMzQ5Mzc2MTcsLTE5MTI4ODQ0NzgsND
