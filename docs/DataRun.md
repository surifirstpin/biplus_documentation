...
Using data analysis user can retrieves the data and build the query by applying data exploration with slice and dice of report information.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc5MTEzNTA5N119
-->