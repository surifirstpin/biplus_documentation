...
Using data analysis user can retrieve the data and build the query, by applying data exploration by slice and dice of report information.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTcwMDAxOTQxXX0=
-->