...
**PivotTable** can instantly **calculate** and **summarize** the data in a way that it is both easy to read and manipulate.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODQ0MDM1NjUzLC0xOTEyODg0NDc4LDQyOT
