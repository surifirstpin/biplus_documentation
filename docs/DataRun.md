...
To view the column data in ascending and descending orders add the fields in order section and select the desired view for the column fio.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY1NjExMTM0NCwtMTkxMjg4NDQ3OCw0Mj
