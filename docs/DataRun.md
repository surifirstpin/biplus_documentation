...
- **Calculate on Raw data** Calculates the field value before applying grouping ,pivot or other parameters or else calculates 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk1NTczNjY5M119
-->