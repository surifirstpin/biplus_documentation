...
## Group / Un-Group
 ...
 In Order to retreive the total valueSelect **Group** options to group fields and select **Un-Group** to release the same.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwOTg4ODM2MTksLTE5MTI4ODQ0NzgsND
