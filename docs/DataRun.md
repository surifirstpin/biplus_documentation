...
To view the column data in ascending or descending orders , add the column fields in order section to carry out the sorting on the field values.iew for the column field.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NTI5NzU0ODQsLTE5MTI4ODQ0NzgsND
