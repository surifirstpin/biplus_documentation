...
> the retreived data based on mathematical calculation appeasr in green colouyr as shown in below image,
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExNzY3ODA5MzUsLTE5MTI4ODQ0NzgsND
