...
Using the search option provided in the visualization section you can select the fields for which you want to carryout the field values and apply filter options.
...
## Pivot table
                  ...
                  welcome to biplus
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MjEyNTM5MjddfQ==
-->