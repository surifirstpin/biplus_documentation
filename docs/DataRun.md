...
- **Rows** diaplays number of rows fetched while retrieving data.
6. **Totals** 
7. **Limit** allows row limitation while displaying data. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTUyNTQzNTM4MSwtMTkxMjg4NDQ3OCw0Mj
