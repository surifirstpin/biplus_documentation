...
Analysis section retrieves the data in the desired combinations by allowing 
 slice and dice of the data information, AcuBi provides you an ability to explore the data by applying following functions.
- Filters to retreicve the data 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA4NjUyMjQ0MCwtMTkxMjg4NDQ3OCw0Mj
