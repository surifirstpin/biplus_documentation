...
To Freeze the column field values while scrolling the data to right in the data retrieved select **Pin** option by clicking one down arrow of the field header  to release the same click on **Remove Pin.**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIzNjI1MjQyMywtMTkxMjg4NDQ3OCw0Mj
