...
To Freeze the column field values in the data retrieved click on the down arrow of the field header and select **Pin** option
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTcwNDgzODg0NSwtMTkxMjg4NDQ3OCw0Mj
