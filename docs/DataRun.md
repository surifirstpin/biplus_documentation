...
Filters is a optional list of filter expression applied to measure calculation,below are the available operations that can be applied for String , 
...
## Pivot table
                  ...
                  welcome to biplus
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDEwOTE4MTIyXX0=
-->