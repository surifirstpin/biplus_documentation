...
Analysis section displays the data of your desired combination by 
y slice and dice of report information in order to build a query.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAxNTkwMTIyNiwtMTkxMjg4NDQ3OCw0Mj
