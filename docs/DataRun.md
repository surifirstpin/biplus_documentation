...
## Definition
Using data analysis user can retrieve the data and build the query by applying data exploration with slice and dice of report information.

## Build Query
Under data analysis section, select the project and model for which you want to explore the data.Data analysis sections contains dimension and measures which acts as fundamental building blocks for a query.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM1MzQ1ODc1OF19
-->