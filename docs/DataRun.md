...
To view the column data in ascending or descending orders , add the column fields in order section to carry out the sorting on the field  and select the desired view for the column field.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTEwMTUzMTg3MCwtMTkxMjg4NDQ3OCw0Mj
