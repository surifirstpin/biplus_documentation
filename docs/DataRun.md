...
To view the column data in ascending or descending orders , add the column fields in order section to carry out the sorting on the field values and select the desired view for the column field.
...
To freeze the column field values while scrolling the data to right or left click **Pin** for the field and release the same by clicking on **Remove Pin.**
...
Group will display the consolidated or a grouped value of the field. To carry out this function Click on **Group** for the field and to release the same Click on **Un-Group**. 
...
Using AcuBi you can apply Multi-level grouping 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQyMzU5NDg3NiwtMTkxMjg4NDQ3OCw0Mj
