...
You can hide the field values in  the visualization charts by selecting **Hide Visualization** for the  field and to display the same in visualization chart select **Show visualization**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM4MzkyNzA5OCwtMTkxMjg4NDQ3OCw0Mj
