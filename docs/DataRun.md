...
For instance, if you want to view the number of order received made based on the month and year it displays in following way:
|Sales  |year  |month|
|--|--|
|  |  |
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzY1ODIxOTAyLC0xOTEyODg0NDc4LDQyOT
