...
Data Analysis retrieves the data, perform data exploration with slice and dice of report information by providing pictorial representation of selected data fields.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk2MDYyODM0MF19
-->