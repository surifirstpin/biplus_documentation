...
In the above image you can see, hide_pivot 1st column is seen empty, so in ioder to hide this you need to select check pivot hide first in data section to 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIzOTY1Nzk2NiwtMTg4MjUyMzc3MCwtNz
