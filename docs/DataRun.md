...
Analysis is the starting point of the query, it is designed in such a way that it explaisn  where to pull your datya and how to edit the report
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTY0NjQwMTUsLTE5MTI4ODQ0NzgsNDI5Nj
