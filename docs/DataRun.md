...
- **Query time**display the total query time for the reportof the report is displayed on top of the analysis section.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NjYwMzk2NDgsLTE5MTI4ODQ0NzgsND
