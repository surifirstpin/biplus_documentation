...
>For Instance Consider the elow example we have selected Country Name and  State Name and City Name,Total_Employees Sum and Average and apply grouping on Country Name and State Name.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDEyNDg0OTY5LC0xOTEyODg0NDc4LDQyOT
