...
Using analysis section you can retrieve the data in the desired combinations as per your business requirement  by allowing slice and dice of the data information, AcuBi provides you an ability to explore the data by applying following functions Filters, Order, Sorting, Mathematical Calculations etc.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgwNTgyOTk4MiwtMTkxMjg4NDQ3OCw0Mj
