...
To **Pivot** a dimension click on pivot for dimension before running the query and you can add more pivots to other dimension but make sure you have atleast one unpivoted dimension ans
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA4NDM5Mjk0OSwtMTkxMjg4NDQ3OCw0Mj
