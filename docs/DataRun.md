...
> **For instance** : in the below image grouping has been applied to 2 dimension fields Country Name and  State Name. In retrieved data on expanding Country Name it displays the perspective State Names that fall under specific country and on Further Expansion it displays City Names that fall under the spec that falls under the states as shown in below image.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTUxOTI1ODU0LC0xOTEyODg0NDc4LDQyOT
