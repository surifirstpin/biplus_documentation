...
To **Pivot** a dimension click on pivot for dimension before running the query and add a measure and atleast one un-pivoted dimensions,  you can add more pivots to other dimension but make sure you have atleast one unpivoted dimension and 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NjMyMTM4OTEsLTE5MTI4ODQ0NzgsND
