...
|in_global_key|it returns the data from global parameters based on the multiple common references.this references can be static or column.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg1NDE5NzMyNV19
-->