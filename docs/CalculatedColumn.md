...
By enabling calculate on raw function is applied directly on the retrieved value of the fields, initially before pivot or grouping options are applied.
```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU0MzgwNjIxNCwxMTU2NzE1MzA2XX0=
-->