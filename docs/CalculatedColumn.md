...
|  contains | Returns true if the Column mentioned contains the followed ‘Sub-String’, else it returns false | contains(if the given reference value has matched in the col it gives true or else false) |
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYyMjA0ODI3N119
-->