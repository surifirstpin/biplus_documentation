...
|calculate_key_group|Returns an aggregated value of a measure based on a dimension with further mention of row grouping column name|
bsdhajdadak
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA3MDYyMTI1OF19
-->