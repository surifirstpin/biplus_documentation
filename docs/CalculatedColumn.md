...
For example : consider the below image in which the  number 2 is added to sum_amount and retreive data by enabling calculate on raw 
```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NTY1MjY2NTAsMTE1NjcxNTMwNl19
-->