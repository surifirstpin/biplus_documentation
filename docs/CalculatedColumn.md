...
>**For example** : consider the below image in which represents calculated data with and without applying enabling calculate on raw.
```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI3MjY4MjgyNywxMTU2NzE1MzA2XX0=
-->