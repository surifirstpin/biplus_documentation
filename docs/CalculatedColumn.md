...
|  contains | Returns true if the Column mentioned contains the followed ‘Sub-String’, else it returns false | contains(if the given name given any name from the table like reference = "prabhas",if it is  present in the given col it gives true or else false) |
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMjM0ODI2NjddfQ==
-->