...
| days_till_month | Returns the total number of days completed in a month for a given date / time stamp | bi.days_in_month (${Col_name}) Ex: bi.days_in_month(“2018-02-01 15:32:26”) = 28 |
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAzMTk5ODk3M119
-->