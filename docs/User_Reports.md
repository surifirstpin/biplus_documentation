...
> **Note :** BiPlus Home page immediately displays the dashboard or Report set by other users on homepage,  depending on your requirement you can set a report or dashboard to BiPlus Home page for easy access.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwOTg2ODg0NjQsMTM4NTIxNDM3Niw5ND
