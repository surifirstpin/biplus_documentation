...
> **For instance** : in the below image grouping has been applied to 2 dimension fields **Station code** and **Whe.** In retrieved data on expanding Station code it displays the perspective **EmployeeID** on Further Expansion of **EmployyeID** it displays Role of the Employee  as shown in below image.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NDM2MzczODIsLTE4NTYxNDM3NzUsMz
