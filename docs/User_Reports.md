...
> **For instance** : in the below image grouping has been applied to 2 dimension fields **Station code** and **Whenmade (hour).** In retrieved data on expanding Station code it displays the perspective number of records available in that particular **Whenmade (hour)** ,on Further Expansion, it displays orderid
![
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NTQwMDU5NzgsLTE4NTYxNDM3NzUsMz
