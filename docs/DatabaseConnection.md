...
-  Using an IP Address Whitelist, optionally adding SSL Encryption.
  - Using an SSH Tunnel, which provides an secured connection and extra authentication and also more time consu.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA5OTI1MzA0NSw0Mzg3NDYwNzMsMjEwND
