...
**Over SSH** network protocol for operating network services protocol securely protect the data using a user and access key assigned to it
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4NDE5MTY2MjUsNDM4NzQ2MDczLDIxMD
