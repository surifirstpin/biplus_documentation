...
## Create  a connection 
 ...
 3. On your database, set it up to work with BiPlus. The instructions may vary different  from dialect to dialect. Typically it inccludes adding acess to Bi
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NDEzNTI5NTQsNDM4NzQ2MDczLDIxMD
