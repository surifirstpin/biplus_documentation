...
## Create  a connection 
 ...
 3. On your database, set it up to work with BiPlus. The instructions may vary different  from dialect to dialect. Typically it inccludes adding acess to
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM1MTM4MDM5Nyw0Mzg3NDYwNzMsMjEwND
