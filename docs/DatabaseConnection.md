...
if connecting with separate database host the you need to provide following information to your BIPlus analyst:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMTc4Nzg4NzAsNDM4NzQ2MDczLDIxMD
