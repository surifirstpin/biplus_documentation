...
## Create  a connection 
 ...
 3. On your database, set it up to work with BiPlus. The instructions may vary different  from dialect to dialect. Typically it 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc1MjQzNTAxNCw0Mzg3NDYwNzMsMjEwND
