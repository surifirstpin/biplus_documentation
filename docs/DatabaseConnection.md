...
If you want to conneBi+ connecting through SSH tunnel with same database host,you need to provide the following information to BiPlus analyst:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3MzQ1ODc1MjgsLTI0NDk2MTQxNiwxNT
