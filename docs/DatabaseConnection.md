...
If you want to connect Bi+ connecting through SSH tunnel with same database host,you need to provide the following information to BiPlus analyst:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTMyMjE0NDU5OSwtMjQ0OTYxNDE2LDE1Mz
