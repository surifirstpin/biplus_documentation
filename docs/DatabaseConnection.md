...
-  Using an IP Address Whitelist, optionally adding SSL Encryption.
  - Using an SSH Tunnel, which provides a secured anconnection and extra authentication and also more time consuming.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk1NDIwNTIxMSw0Mzg3NDYwNzMsMjEwND
