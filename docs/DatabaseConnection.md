...
-  Using an IP Address Whitelist, optionally adding SSL Encryption.
  - Using an SSH Tunnel, which provides an secured connection and extra authentication and also more time consumption.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzAxMzMwOTI0LDQzODc0NjA3MywyMTA0Nz
