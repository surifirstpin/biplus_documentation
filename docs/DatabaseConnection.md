...
In case if you are connecting through SSH tunnel same as your database host,you need to provide the following information to BiPlus analyst:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzUyNTkxOTk0LDQzODc0NjA3MywyMTA0Nz
