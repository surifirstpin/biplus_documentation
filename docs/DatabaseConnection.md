...
**III.** Set up database to work with Bi+. nstructions may vary from dialect to dialect. Typically it includes providing approval to Bi+ to access database.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMTk3NjI3MCwtMjQ0OTYxNDE2LDE1Mz
