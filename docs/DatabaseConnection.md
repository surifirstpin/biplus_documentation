...
## Create  a connection 
 ...
 3. On your database, set it up to work with BiPlus. The instructions may vary different  from dialect to dialect. it Typically the steps include adding permissions for Looker to access the database and possibly creating a scratch schema for Looker to create derived tables in the database.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTk1Mzc2MDQ1LDQzODc0NjA3MywyMTA0Nz
