...
## Create  a connection 
   ...
   **Connection** specifies a database connection from which a model can retrieve the data. Folllowing aee the steps to followed to set up the connection.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTgwNDA5NDcyLDQzODc0NjA3MywyMTA0Nz
