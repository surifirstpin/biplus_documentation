...
In case if you are connecting through SSH tunnel ,you need to provide tfollowing information to BiPlus analyst:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTE5MTY2NDQ4LDQzODc0NjA3MywyMTA0Nz
