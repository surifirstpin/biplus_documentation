...
Bi+ allows multiple report layouts format. Select suitable layout from given options available, it is also provided with ability to add,edit and delete the reports layout. 
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQwODUxMDI2NV19
-->