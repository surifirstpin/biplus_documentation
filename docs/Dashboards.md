...
Bi+ allows multiple report layouts format. Depending on the requirement, select the suitable layout from given options available and at the same time it can be added, edit and delete the reports layout. 
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE1NTYzMzE1Nl19
-->