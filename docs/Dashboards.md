...
Bi+ allows multiple report layouts format. Depending on the requirement select suitable layout from given options available, at the same time Bi+ is provided with an option to add, edit and delete the reports layout. 
...
Click  **Edit** Button to make any changes to dashboard created. 
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5Mjg2NDkxMDldfQ==
-->