...
## Edit   Dashboard 
   ...
   To Edit the dashboard Select the dashboard created and Click on **Edit** Button.It will anvigate to Dashboard created with all the
...
Add Filters to the Dashboard as shown in below image
...
## Home Page Display Option
           ...
           welcome to Biplus
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzA4MTMyODA1XX0=
-->