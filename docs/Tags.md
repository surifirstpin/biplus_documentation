...
Tag has a hirarichal struction that provides a several layers of nesting like parent tag and child tag provides the total path of saved reports and dashboards.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTUzNTIyMjY2N119
-->