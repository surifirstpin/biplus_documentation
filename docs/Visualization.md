...
AcuBi has an ability to create graphics and charts based on query result. Visualization displays different type of pictorial representation in the from of charts and graphs based on data retrieved.
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0NDkwNDAxMzgsMTI1MjkwNDEyNV19
-->