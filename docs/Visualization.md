...
On Analysis page click on visualization ** (Replace with charts)**  tab to configure visualization option for the result obtained. Under general section click on the type of chart you want to view or 
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAzNDY2MTI0NSwtNDYyNzY2MjM1LDEyNT
I5MDQxMjVdfQ==
-->