...
### Reference lines in bubble chart :
  ...
  - **Type** specifies how y-axis scale is calculated and displayed,Below are the options available to enable the scale typ
## Funnel chart :
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI0Nzk3NzE3NywtMTE5NjAxNjgzMiwtMT
