...
AcuBi has an ability to create graphics and charts based on query resultVisualization displays different type of pictorial representation in the from of charts and graphs based on data retrieved.
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA5NTU5NjY0OCwxMjUyOTA0MTI1XX0=
-->