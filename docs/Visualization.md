...
On Analysis page click on visualization (Replace with charts)  tab to configure visualization for the result obtained.
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjEyNDAwNDczMiwtNDYyNzY2MjM1LDEyNT
I5MDQxMjVdfQ==
-->