...
### Definition 
Visualisation provides different type of pictorial represeBi+ allows you to create different type of charts and graphs depending on the data retrieved.
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ2Mjc1NDU3OF19
-->