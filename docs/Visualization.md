...
On Analysis page click on visualization ** (Replace with charts)**  tab to configure visualization option for the result obtained.
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA1Njg2NjkxLC00NjI3NjYyMzUsMTI1Mj
kwNDEyNV19
-->