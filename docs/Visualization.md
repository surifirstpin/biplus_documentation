...
- **Show ticklabels** on selecting the show ticklabels checkbox it enabled measure values of measures in y-axis.
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAyMTQ0MjYxNywtNDYyNzY2MjM1LDEyNT
I5MDQxMjVdfQ==
-->