...
### Reference lines in bubble chart :
  ...
  - **Type** specifies how y-axis scale is calculated and displayed,Below are the options available to enavbk
## Funnel chart :
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjk1NzcyMzc5LC0xMTk2MDE2ODMyLC0xOT
