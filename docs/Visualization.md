...
### Definition 
Visualisation provides different type of pictorial Bi+ allows you to create different type of charts and graphs depending on the data retrieved.
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYxODkzOTkzMF19
-->