...
### Definition 
Visualisation provides different typeBi+ allows you to create different type of charts and graphs depending on the data retrieved.
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk5MDYxNjM3Nl19
-->