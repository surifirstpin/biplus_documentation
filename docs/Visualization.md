...
### Reference lines in bubble chart :
  ...
  - **Type** specifies how y-axis scale is calculated and displayed,Below are the options available to enable the sca
## Funnel chart :
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4NDM5MDk0NDMsLTExOTYwMTY4MzIsLT
