...
A model is a customized gateway into the database, it is designed in such a way that it provides a spontaneous data analysis to partiexploration 
...
``` 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIzNzk0ODUyNl19
-->