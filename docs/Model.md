...
Login based filter enables you to apply user-specific restrictions. for this you need to be associated with global parameter under settings section in BI+ to work efficienntly.
...
``` 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIyNTY2NTA3OF19
-->