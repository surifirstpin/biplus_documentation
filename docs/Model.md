...
## Derived Table
Derived tables enables you to refine your data analysis more precisely.it creates a new table that doesnt exist in your database already.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAyNjczODY5XX0=
-->