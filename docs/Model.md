...
Login based filter enables you to apply user-specific restrictions. for this you need to be associated with global parameter under settings section in BI+ to w
...
``` 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgwODMyMTcyMl19
-->