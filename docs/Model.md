...
Login based filter enables you to apply user-specific restrictions. for this you need to be associated with global parameter under settings section in BI+ to work eff
...
``` 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM1Mjk4OTU1NV19
-->