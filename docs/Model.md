...
## Derived Table
Derived tables enables you to refine your data analysis more precisely.it creates a new temporary table that doesn't exist in your database already, they either be built at youquery time or they can be stored in your database.you can define the derived table by writing a SQL query and uses it results as derived table.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg5Mzg0MjAxMV19
-->