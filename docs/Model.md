...
Login based filter enables you to apply user-specific restrictions. for this you need to be associated with global parameter under settings section 
...
``` 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNjM2MDYwOTddfQ==
-->