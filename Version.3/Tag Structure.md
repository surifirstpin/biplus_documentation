...
- To create a **Child Tag** select under the desired parent tag. You can add multiple child tags in parent tag.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNDUxMTc0MTYsLTEyNDk4MzYwNDIsMj
