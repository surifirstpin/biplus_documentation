...
In your query result you can view the data ascending or descending order by applying sorting. to enable sorting Click on column header
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MzAwODc2MDMsNTY5NzYxNiw1OTU3NT
