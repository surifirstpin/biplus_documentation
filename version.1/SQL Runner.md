...
SQL Runner can create a derived view from the query build at the same time you can use this view in model section. the dialects used for the query should match the
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA5ODY3OTkxNSwxNDY0MTg2MjExLDE4OD
