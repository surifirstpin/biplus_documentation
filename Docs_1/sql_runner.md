...
Using SQL Runner you can directly access database and clout the access in variety of ways. it can easily set up the connection, and navigate the tables under your schema. In sql runner you can run the  pre-written SQL queries, view run history. create your customs views and perform useful task with them in model section.  
...
- All the created tags are visible in **Tagged Section**.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0ODY4MzE1NzIsLTgxMjAxNDkyMiwtMj
