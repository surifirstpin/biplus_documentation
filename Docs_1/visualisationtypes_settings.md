...
- **Custom Label** It displays customized label for the column field value. Add a prefix or Suffix at starting or ending position of the label value.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA3MzcyNjE3OSwtMTcwOTQ1NzEwLDE1Nz
