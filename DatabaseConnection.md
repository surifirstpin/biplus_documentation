...
## SSH 
In case if you are connecting BiPlus to your database without using SSH tunnel, please proceed on to Database Configuration.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI1OTMyNjMyNywxMzY0NzQyNzEzLC0xOD
