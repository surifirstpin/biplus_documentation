...
You can make use of **Analysis Section** to create a query and copy paste the same query in sql area and get SQL command.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQxNzQ1MzIyMywtNDEzODU0NzgsMTU4Nz
