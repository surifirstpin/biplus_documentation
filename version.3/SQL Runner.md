...
- You can directly write the SQL query from scratch and run i make sure the dialects used in SQL runner should match the database dialects. 
...
- All the created tags are visible in **Tagged Section**.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MDQ4NDk5ODksMTM4NDYxMDAxMSw4MT
