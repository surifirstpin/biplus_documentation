...
- **Show percentage**  displays percentage for each measure value in pie chart. To enable this opselect the **Check Box** show percentage as shown below;
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ4MTU1NzI5OSwtNTI2MjAwMDE3LC0xNT
